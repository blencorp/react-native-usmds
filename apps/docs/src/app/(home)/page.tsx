        ...
        <div className='container mx-auto px-4 max-w-6xl'>
          <div className='flex flex-col md:flex-row items-center justify-between gap-8'>
            <div className='md:w-1/2 space-y-6'>
              ...
              <p className='text-xl md:text-2xl font-light'>U.S. Mobile Design System components for React Native applications</p>
              <div className='flex flex-wrap gap-4'>
                ...
                <Link href='/docs/components' className='px-6 py-3 bg-blue-800 text-white font-medium rounded-md hover:bg-blue-900 transition'>
                  Components
                </Link>
              </div>
            </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <Link href='/docs/components/alert' className='group'>
              <div className='bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition'>
                <h3 className='text-xl font-bold mb-3 group-hover:text-blue-600'>Alert</h3>
                <p className='text-gray-600 mb-4'>Display important messages to users with various severity levels.</p>
            ...
            <Link href='/docs/components/button' className='group'>
              <div className='bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition'>
                <h3 className='text-xl font-bold mb-3 group-hover:text-blue-600'>Button</h3>
                <p className='text-gray-600 mb-4'>Interactive button elements with multiple variants and sizes.</p>
                <p className='text-blue-600 font-medium'>View component →</p>
              </div>
            </Link>
            ...
            <Link href='/docs/components/card' className='group'>
              <div className='bg-white p-6 rounded-lg border border-gray-200 hover:border-blue-500 transition'>
                <h3 className='text-xl font-bold mb-3 group-hover:text-blue-600'>Card</h3>
                <p className='text-gray-600 mb-4'>Versatile containers for displaying content and actions.</p>
                <p className='text-blue-600 font-medium'>View component →</p>
              </div>
            </Link>
          </div>
          ...
          <div className='flex flex-col md:flex-row items-center gap-8'>
            <div className='md:w-1/2'>
              ...
              <p className='text-gray-600 mb-6'>
                Start building your React Native application with USMDS components. Follow our step-by-step guide to install and configure the
                library.
              </p>
              <div className='flex flex-wrap gap-4'>
                <Link
        ...
        <div className='container mx-auto px-4 max-w-6xl'>
          <div className='flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className='flex gap-6'>
              ...
              <a href='https://github.com/blencorp/react-native-usmds' className='hover:text-blue-400 transition'>
                GitHub
              </a>
            </div>
          </div>
