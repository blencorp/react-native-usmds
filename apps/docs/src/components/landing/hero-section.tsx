    ...
    <section className="relative overflow-hidden bg-[#002d72]">
      <div className="mx-auto max-w-6xl px-4 py-16 sm:py-20 md:py-24">
        <div className="grid items-center gap-10 md:grid-cols-2">
          <div>
            <h1 className="lg:text-6xl text-balance leading-tight text-white md:text-3xl sm:text-sm">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-md bg-white px-4 py-2 font-medium shadow-sm transition hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-white/80 focus:ring-offset-2 focus:ring-offset-[#002d72]"
              >
                Get Started
              </Link>
              <Link
