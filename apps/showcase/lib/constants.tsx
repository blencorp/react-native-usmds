...
const PREVIEW_REGISTRY: Record<string, ShowcasePreview[]> = {
  ...
  buttongroup: [
    { name: "Orientations", component: Examples.ButtonGroupPreview },
  ],
  ...
  "native-only-animated-view": [
    {
      name: "Animated Panel",
      component: Examples.NativeOnlyAnimatedViewPreview,
    },
  ],
  ...
  radiobutton: [
    { name: "Radio Buttons", component: Examples.RadioButtonPreview },
  ],
  ...
  stepindicator: [
    { name: "Step Indicator", component: Examples.StepIndicatorPreview },
  ],
  ...
  "toggle-group": [
    { name: "Toggle Group", component: Examples.ToggleGroupPreview },
  ],
...
export const REGISTRY_ENDPOINT =
  "https://storage.googleapis.com/usmds-registry/r/usa.json";

export function buildComponentMap(
  items: RegistryItem[],
): Record<string, ShowcaseComponent> {
  return items
...
export function buildComponentList(
  map: Record<string, ShowcaseComponent>,
): ShowcaseListItem[] {
