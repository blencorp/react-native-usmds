    ...
    <Dialog>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>This is a simple dialog that demonstrates the basic functionality.</DialogDescription>
        </DialogHeader>
        <View className='py-4'>
          <Text className='text-base text-foreground'>Dialogs are great for displaying important information or getting user confirmation.</Text>
        </View>
        <DialogFooter>
          <DialogClose asChild>
            <Button variant='outline'>
