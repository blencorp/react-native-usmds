...
describe("Banner", () => {
  it("renders standard app banner correctly", () => {
    ...
    expect(
      getByText("An official website of the United States government"),
    ).toBeTruthy();
  ...
  it("renders welcome banner correctly", () => {
    const { getByTestId, getByText } = render(
      <Banner variant="welcome" title="Welcome Message" />,
    );
  ...
  it("renders different languages", () => {
    ...
    expect(
      getByText("Un sitio oficial del Gobierno de Estados Unidos"),
    ).toBeTruthy();
